...
class TestAgentCreateView(AgentViewTestBase):
    ...
    def test_organisor_create_agent(self):
        ...
        self.assertEqual(response.status_code, 200)  # 200 because required fields (phone_number, profile_image) are missing
...
class TestAgentUpdateView(AgentViewTestBase):
    ...
    def test_organisor_post_update(self):
        ...
        self.assertEqual(response.status_code, 200)  # 200 because required field (phone_number) is missing
